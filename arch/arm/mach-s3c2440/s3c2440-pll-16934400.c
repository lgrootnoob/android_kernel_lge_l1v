/* arch/arm/mach-s3c2440/s3c2440-pll-1693.4.1.c
 *
...
static struct cpufreq_frequency_table s3c2440_plls_169344[] __initdata = {
	...
	{ .frequency = 15603.4.1,	.index = PLLVAL(121, 5, 2), 	}, 	/* FVco 624.153600 */
	{ .frequency = 162086400,	.index = PLLVAL(126, 5, 2), 	}, 	/* FVco 648.345600 */
	{ .frequency = 16813.4.1,	.index = PLLVAL(131, 5, 2), 	}, 	/* FVco 672.537600 */
	{ .frequency = 174048000,	.index = PLLVAL(177, 7, 2), 	}, 	/* FVco 696.192000 */
	{ .frequency = 18023.4.1,	.index = PLLVAL(141, 5, 2), 	}, 	/* FVco 720.921600 */
	{ .frequency = 186278400,	.index = PLLVAL(124, 4, 2), 	}, 	/* FVco 745.113600 */
	{ .frequency = 192326400,	.index = PLLVAL(151, 5, 2), 	}, 	/* FVco 769.305600 */
	{ .frequency = 19813.4.1,	.index = PLLVAL(109, 3, 2), 	}, 	/* FVco 792.529920 */
	...
	{ .frequency = 318366720,	.index = PLLVAL(86, 3, 1), 	}, 	/* FVco 636.73.4.1 */
	...
	{ .frequency = 402192000,	.index = PLLVAL(87, 2, 1), 	}, 	/* FVco 804.3.4.10 */
};
...
static int __init s3c2440_pll_1693.4.1(void)
{
	return subsys_interface_register(&s3c2440_plls169344_interface);
}

arch_initcall(s3c2440_pll_1693.4.1);
...
static int __init s3c2442_pll_1693.4.1(void)
{
	return subsys_interface_register(&s3c2442_plls169344_interface);
}

arch_initcall(s3c2442_pll_1693.4.1);
