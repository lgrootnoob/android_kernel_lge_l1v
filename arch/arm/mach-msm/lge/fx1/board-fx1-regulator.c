...
#if defined(CONFIG_MACH_MSM8960_FX1) /* LGE_CHANGE, add for FX1 Camera, 2012.07.10 jihyun.song */
...
VREG_CONSUMERS(L29) = {
	 ...
	 */
#elif defined(CONFIG_MACH_MSM8960_FX1A) || defined(CONFIG_MACH_MSM8960_FX1V) || defined (CONFIG_MACH_MSM8960_FX1T) || defined (CONFIG_MACH_MSM8960_FX1SK)
	/* LGE_CHANGE
	 * After bring-up the draft version, The Audience dev have to be added. VREG_L29.
	 * 2012-06-28 kideok.kim@lge.com
	 */
...
/* FX1_SKT_KR L29 is +V1P8_L29_TOUCH_VIO (1.8V) : RPM_LDO declared */
#else
#ifdef CONFIG_MACH_LGE
...
msm_rpm_regulator_init_data[] __devinitdata = {
	...
	*/
	...
	#if defined (CONFIG_MACH_MSM8960_FX1SK)
	/* FX1_SKT_KR L29 is +V1P8_L29_TOUCH_VIO (1.8V) */
