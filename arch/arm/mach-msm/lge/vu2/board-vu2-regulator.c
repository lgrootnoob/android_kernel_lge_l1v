...
#if defined(CONFIG_MACH_MSM8960_VU2) /* LGE_CHANGE, add for FX1 Camera, 2012.07.10 jihyun.song */
...
VREG_CONSUMERS(L29) = {
	 ...
	 */
#elif defined(CONFIG_MACH_MSM8960_FX1A) || defined(CONFIG_MACH_MSM8960_FX1V) || defined (CONFIG_MACH_MSM8960_FX1T) || defined (CONFIG_MACH_MSM8960_VU2)
	/* LGE_CHANGE
