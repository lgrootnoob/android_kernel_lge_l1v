...
#if defined(CONFIG_MACH_MSM8960_D1LU) || defined(CONFIG_MACH_MSM8960_D1LSK) || defined(CONFIG_MACH_MSM8960_D1LKT) || defined(CONFIG_MACH_MSM8960_VU2) || defined(CONFIG_MACH_MSM8960_L_DCM) || defined(CONFIG_MACH_MSM8960_L0) || defined(CONFIG_MACH_MSM8960_D1LV)
 ...
 *                                                      |<------------ Vbat>4  STOP|
 * decreasing temp ~~ <--STOP|<-------------------NORMAL|<------------ Vbat<=4 DC  |<-- STOP ~~
...
static int chg_is_battery_too_hot_or_too_cold(void *data, int batt_temp, int batt_level)
{
	...
	*/
	 ...
	 *  -- vbatt > 4.0V  : normal, dc current --> stop charging without changing UI
	 *  -- vbatt <= 4.0V : normal, stop charging --> decrease charing current(450mA) */
