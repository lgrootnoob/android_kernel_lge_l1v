...
#if defined(CONFIG_MACH_MSM8960_VU2)
	if(ts == NULL){
		printk("[TOUCH] %s : ts data is NULL .\n", __FUNCTION__);
		return -EIO;
	}
#endif
	if (touch_debug_mask & DEBUG_TRACE)
