...
static char n_gamma_r_setting[10] = {0xD1, 0x10, 0x01, 0x57, 0x46, 0x01, 0x06, 0x70, 0x45, 0x04};
static char p_gamma_g_setting[10] = {0xD2, 0x10, 0x01, 0x50, 0x46, 0x01, 0x06, 0x70, 0x45, 0x04};
static char n_gamma_g_setting[10] = {0xD3, 0x10, 0x01, 0x57, 0x46, 0x01, 0x06, 0x70, 0x45, 0x04}; 
static char p_gamma_b_setting[10] = {0xD4, 0x10, 0x01, 0x50, 0x46, 0x01, 0x06, 0x70, 0x45, 0x04}; 
static char n_gamma_b_setting[10] = {0xD5, 0x10, 0x01, 0x57, 0x46, 0x01, 0x06, 0x70, 0x45, 0x04}; 

#if defined(LGIT_IEF)
static char ief_on_set0[2] = {0x70, 0x07};
static char ief_on_set1[5] = {0x71, 0x00, 0x00, 0x01, 0x01};
static char ief_on_set2[3] = {0x72, 0x01, 0x0F};
static char ief_on_set3[4] = {0x73, 0x34, 0x66, 0x40};
static char ief_on_set4[4] = {0x74, 0x04, 0x0F, 0x02};
static char ief_on_set5[4] = {0x75, 0x03, 0x8F, 0x07};
...
static char osc_setting[3] =     {0xC0, 0x00, 0x04};
static char power_setting3[10] = {0xC3, 0x00, 0x09, 0x10, 0x05, 0x03, 0x11, 0x4A, 0x34, 0x11};
static char power_setting4[6] =  {0xC4, 0x22, 0x24, 0x15, 0x15, 0x4F};
static char power_setting5[4] = {0xC7, 0x10, 0x00, 0x14};
...
#ifdef LGIT_IEF_SWITCH
extern int mipi_lgit_ief_off(void)
{
	if(local_mfd0->panel_power_on && is_ief_on) {
		mutex_lock(&local_mfd0->dma->ov_mutex);	
...
EXPORT_SYMBOL(mipi_lgit_ief_off);

extern int mipi_lgit_ief_on(void)
{
	if(local_mfd0->panel_power_on && !is_ief_on) {
		mutex_lock(&local_mfd0->dma->ov_mutex);	
...
EXPORT_SYMBOL(mipi_lgit_ief_on);
#endif
#endif
