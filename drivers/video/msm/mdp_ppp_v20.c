...
static void mdp_load_bc_upscale_table(void)
{
	...
	MDP_OUTP(MDP_BASE + 0x50248, 0x3.4.13dd);
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xf5c00160);
	MDP_OUTP(MDP_BASE + 0x5024c, 0x3.4.13df);
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xf5c00172);
	MDP_OUTP(MDP_BASE + 0x50250, 0x3.4.13e1);
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xf5c00184);
	MDP_OUTP(MDP_BASE + 0x50254, 0x3.4.13e3);
...
static void mdp_load_bc_downscale_table_x_point4TOpoint6(void)
{
	...
	MDP_OUTP(MDP_BASE + 0x50284, 0x3.4.1084);
	...
	MDP_OUTP(MDP_BASE + 0x50290, 0x3.4.1077);
	...
	MDP_OUTP(MDP_BASE + 0x5029c, 0x3.4.106b);
...
static void mdp_load_bc_downscale_table_x_point6TOpoint8(void)
{
	...
	MDP_OUTP(MDP_BASE + 0x502bc, 0x3.4.1010);
	...
	MDP_OUTP(MDP_BASE + 0x502d4, 0x3.4.1000);
...
static void mdp_load_bc_downscale_table_y_point6TOpoint8(void)
{
	...
	MDP_OUTP(MDP_BASE + 0x5fffc, 0x30000ee);
	MDP_OUTP(MDP_BASE + 0x5033c, 0x3.4.1010);
	MDP_OUTP(MDP_BASE + 0x5fffc, 0x40000f5);
	...
	MDP_OUTP(MDP_BASE + 0x5fffc, 0x9800114);
	MDP_OUTP(MDP_BASE + 0x50354, 0x3.4.1000);
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xac00119);
...
static void mdp_load_bc_downscale_table_x_point8TO1(void)
{
	...
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xf600014d);
	MDP_OUTP(MDP_BASE + 0x502c8, 0x3.4.13dd);
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xf5c00160);
	MDP_OUTP(MDP_BASE + 0x502cc, 0x3.4.13df);
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xf5c00172);
	MDP_OUTP(MDP_BASE + 0x502d0, 0x3.4.13e1);
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xf5c00184);
	MDP_OUTP(MDP_BASE + 0x502d4, 0x3.4.13e3);
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xf6000195);
...
static void mdp_load_bc_downscale_table_y_point8TO1(void)
{
	...
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xf600014d);
	MDP_OUTP(MDP_BASE + 0x50348, 0x3.4.13dd);
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xf5c00160);
	MDP_OUTP(MDP_BASE + 0x5034c, 0x3.4.13df);
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xf5c00172);
	MDP_OUTP(MDP_BASE + 0x50350, 0x3.4.13e1);
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xf5c00184);
	MDP_OUTP(MDP_BASE + 0x50354, 0x3.4.13e3);
	MDP_OUTP(MDP_BASE + 0x5fffc, 0xf6000195);
