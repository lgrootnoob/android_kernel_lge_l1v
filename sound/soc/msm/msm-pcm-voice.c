...
#elif defined(CONFIG_MACH_MSM8960_L1v) || defined(CONFIG_MACH_MSM8960_L0) || defined(CONFIG_MACH_MSM8960_D1LA) || defined(CONFIG_MACH_MSM8960_L_DCM) || defined(CONFIG_MACH_MSM8960_L1A) || defined(CONFIG_MACH_MSM8960_L1E_EVE_GB)
//[AUDIO_BSP]_START, 20120213, junday.lee, modified voice volume level(6->7) for Metro-PCS, D1LA, D1LV, L_DCM
static struct snd_kcontrol_new msm_voice_controls[] = {
	SOC_SINGLE_EXT("Voice Rx Device Mute", SND_SOC_NOPM, 0, 1, 0,
				msm_voice_rx_device_mute_get,
